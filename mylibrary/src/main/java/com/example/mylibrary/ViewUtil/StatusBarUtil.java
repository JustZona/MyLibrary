...
//            transparencyBar(activity,false);
     ...
     */
    public static int statusBarLightMode(Activity activity, boolean isFullScreen){
        int result=0;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
    ...
    public static int statusBarDarkMode(Activity activity, boolean isFullScreen){
        int result=0;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
